...
const { NAME, NEW_FLIGHT_PREFERENCE, ENTER, CREATE, CANCEL } = Labels;
...
export const FlightForm = ({ onSubmit, bool, loading, toggle, current }: FormProps) => (
  <>
    <Modalx
      visible={bool}
      loading={loading}
