...
const { NAME, NEW_CAR_TYPE_PREFERENCE, ENTER, CREATE, CANCEL } = Labels;
...
export const CarTypeForm = ({ onSubmit, bool, loading, toggle, current }: FormProps) => (
  <>
    <Modalx
      visible={bool}
      loading={loading}
